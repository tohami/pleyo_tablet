          ...
          Container(
              ...
              child: IconButton(
                alignment: Alignment.center,
                  iconSize: 48,
                  onPressed: () => Get.rootDelegate.offNamed(Routes.SCAN_QR),
                  icon: Icon(
                    Icons.arrow_back,
                    color: Colors.white,
                  ))),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Builder(builder: (context) {
                    var fields = controller.ticket.attributes?.competition
                        ?.activationScreen?.fields;
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: const [
                                      BoxShadow(
                                        color:
                                            Color(ColorCode.shadowBackground),
                                        offset: Offset(0, 4),
                                        blurRadius: 4,
                                      ),
                                    ],
                    ...
                    children: [
                      Container(
                        ...
                        child: GestureDetector(
                          ...
                          onTapCancel: () =>
                              controller.isButtonTapDown.value = false,
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(
                                          ColorCode.shadowBackground),
                                      offset: const Offset(0, 4),
                                      blurRadius:
                                          controller.isButtonTapDown.value
                                              ? 0
                                              : 4,
                                    ),
                                  ],
