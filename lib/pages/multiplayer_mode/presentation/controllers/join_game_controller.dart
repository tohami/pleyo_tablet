...
class JoinGameController extends SuperController<bool> {
  ...
  void onPlayerNameSelected() async {
    try {
      ...
      var joinMultiplayerGameData = await multiplayerRepository
          .joinMultiplayerGame(
      ...
      var myScore = joinMultiplayerGameData.scores?.firstWhereOrNull((
          element) => StationService.to.currentStation.id == element?.id);
      Get.back();
      await Future.delayed(Duration(milliseconds: 500));
      Get.rootDelegate.toNamed(
          Routes.MULTIPLAYER_GUEST_GAME_STATUS, arguments: {
        "score": myScore?.id,
